...
- **Plugin** ช่วยให้สามารถตรวจสอบ แก้ไข และขยายการทำงานของ Opencode
- **Commands** ช่วยให้สามารถสร้างชุดพรอมต์ที่ใช้บ่อยๆ ได้อย่างรวดเร็ว
- **Hooks** เป็นจุดเชื่อมต่อที่ทำให้ทั้งสองอย่างทำงานร่วมกันได้
